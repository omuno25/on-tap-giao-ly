...
export default function BlogSection({ posts }: BlogSectionProps) {
  ...
  return (
    <section className="mt-10" aria-labelledby="learning-blog-title">
      <h2 id="learning-blog-title" className="font-headline text-2xl font-bold">Trải nghiệm</h2>
        ...
        {posts.map((post) => (
          ...
          >
            <span className="min-w-0 flex-1">
              <span className="line-clamp-2 block font-headline text-sm font-bold leading-snug">{post.title}</span>
              <span className="mt-1.5 block text-xs text-on-surface-variant">{post.readingTime}</span>
            </span>
